...
can cross a trust boundary. Version 0.2 is still an alpha; please report a
...
privately owned directory that no attacker can modify concurrently, keep the
safety limits, leave permission restoration disabled, and inspect the result.
Security support currently covers the newest released alpha.
